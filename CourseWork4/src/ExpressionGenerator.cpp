...
unordered_map<int, int> Combanitor::mNumRanges = {
    {1, 20},
    {2, 50},
    {3, 1000},
    {4, 1000},
...
unordered_map<int, int> Combanitor::mOutRanges = {
    {1, 20},
    {2, 50},
    {3, 1000000},
    {4, 1000000},
...
unordered_map<int, char> Combanitor::mNumToOperators = {
    {0, '+'},
    {1, '-'},
    {2, '*'},
    {3, '/'},
...
unordered_map<char, int> Combanitor::mOperatorToNums = {
    {'+', 0},
    {'-', 1},
    {'*', 2},
    {'/', 3},
...
unordered_map<int, int> Combanitor::mClassToOperators = {
    {1, 1},
    {2, 2},
    {3, 3},
    {4, 3},
